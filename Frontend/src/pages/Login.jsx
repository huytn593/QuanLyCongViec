      ...
      >
        <div className="glass-morphism rounded-3xl p-8 shadow-2xl border border-white/50 bg-white/80">
          <div className="text-center mb-8">
            ...
            <p className="text-secondary-500 mt-2">Nhập thông tin của bạn để truy cập công việc</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary py-3 text-lg shadow-lg shadow-primary-200 flex items-center justify-center gap-2"
            >
              {loading ? (
